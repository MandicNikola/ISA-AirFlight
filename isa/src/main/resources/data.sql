...
insert into user ( id, ime, prezime, mail, telefon, grad, verifikovan, lozinka,tip) values (193,'AdminHOTEL', 'Hotelic','hotel@gmail.com', 0645691,'Beograd', 'da','074af2bf8e84854902eead553819b4517c2bac61c5d367a45831b05bf7789a81','ADMIN_HOTEL');
insert into user ( id, ime, prezime, mail, telefon, grad, verifikovan, lozinka,tip) values (194,'AdminRENT', 'Rentic','rent@gmail.com', 0645691,'Beograd', 'da','074af2bf8e84854902eead553819b4517c2bac61c5d367a45831b05bf7789a81','ADMIN_RENT');
insert into user ( id, ime, prezime, mail, telefon, grad, verifikovan, lozinka,tip) values (195,'AdminSISTEM', 'Adminic','admin@gmail.com', 0645691,'Beograd', 'da','074af2bf8e84854902eead553819b4517c2bac61c5d367a45831b05bf7789a81','ADMIN_SISTEM');
...
insert into rentacar ( id, naziv, adresa, opis) values (1245,'Fast car', 'Kisacka 10','samo brzo');
insert into rentacar ( id, naziv, adresa, opis) values (1255,'Rent a car', 'Kosovska 18','sigurno i lako');
insert into rentacar ( id, naziv, adresa, opis) values (1265,'NS the best', 'Dunavska 22','samo brzo');
